const BossList = [
  // 炎魔
  {
    ...
    name: 'zakum',
    difficulties: [
      { difficulty: 'easy', mesos: 200000, hp: 2200000, drops: ['stone'] },
      { difficulty: 'normal', mesos: 612500, hp: 7000000, drops: ['stone'] },
    ],
    defeatType: 'day',
    defeatTime: 1,
  },
  ...
  // 梅格奈斯
  {
    ...
    name: 'magnus',
    difficulties: [
      { difficulty: 'easy', mesos: 722000, hp: 400000000, drops: ['stone'] },
      {
        difficulty: 'normal',
        mesos: 2592000,
        hp: 6000000000,
