  ...
  // 炎魔
  {
    ...
    difficulties: [
      { difficulty: 'easy', mesos: 200000, hp: 2200000, drops: ['red-stone'] },
      {
        ...
        mesos: 612500,
        hp: 7000000,
        drops: ['red-stone', { name: 'crusaders_coin', value: 6 }],
      },
    ],
    defeatType: 'day',
    defeatTime: 1,
    ...
    difficulties: [
      {
        ...
        mesos: 16200000,
        hp: 84000000000,
        drops: ['red-stone', { name: 'crusaders_coin', value: 26 }],
      },
    ],
    defeatType: 'week',
    defeatTime: 1,
  ...
  // 梅格奈斯
  {
    ...
    difficulties: [
      ...
      },
      {
        ...
        mesos: 2592000,
        hp: 6000000000,
        drops: ['red-stone', { name: 'crusaders_coin', value: 12 }],
      },
    ],
    defeatType: 'day',
    defeatTime: 1,
    ...
    difficulties: [
      {
        ...
        mesos: 11250000,
        hp: 16800000000,
        drops: ['red-stone', { name: 'crusaders_coin', value: 24 }],
      },
    ],
    defeatType: 'week',
    defeatTime: 1,
    ...
    difficulties: [
      {
        ...
        mesos: 1058000,
        hp: 700000000,
        drops: ['red-stone', { name: 'crusaders_coin', value: 7 }],
      },
      {
        difficulty: 'normal',
        mesos: 1458000,
        hp: 6300000000,
        drops: ['red-stone', { name: 'crusaders_coin', value: 10 }],
      },
      {
        difficulty: 'hard',
        mesos: 2450000,
    ...
    difficulties: [
      {
        ...
        mesos: 1152000,
        hp: 2100000000,
        drops: ['red-stone', { name: 'crusaders_coin', value: 8 }],
      },
      {
        difficulty: 'normal',
        mesos: 2520500,
